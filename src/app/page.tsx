          ...
          <Card className="max-w-2xl mx-auto bg-white/95 backdrop-blur-sm">
            ...
            <CardContent className="text-gray-700">
              <p className="text-lg leading-relaxed">
                Você pode fazer o <strong>Simulado 1</strong> e <strong>Simulado 2</strong> com 2 questões gratuitamente.
              </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <Card className="bg-white/10 backdrop-blur-sm border-white/20">
            <CardHeader>
              ...
              <CardTitle className="text-white">Inteligência Artificial</CardTitle>
              <CardDescription className="text-white/80">
                Trilhas personalizadas e análise de desempenho com IA
              </CardDescription>
            </CardHeader>
          </Card>
